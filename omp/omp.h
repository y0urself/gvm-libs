...
int omp_authenticate_info_ext_c (gvm_connection_t *,
                                 omp_authenticate_info_opts_t);
...
int omp_start_task_report_c (gvm_connection_t *, const char *, char **);

int omp_stop_task (gnutls_session_t *, const char *);

int omp_stop_task_c (gvm_connection_t *, const char *);

int omp_resume_task_report (gnutls_session_t*, const char*, char**);

int omp_resume_task_report_c (gvm_connection_t *, const char *, char **);
