 ...
 */
int
omp_authenticate_info_ext_c (gvm_connection_t *connection,
                             omp_authenticate_info_opts_t opts)
{
  entity_t entity;
  const char* status;
 ...
 */
int
omp_start_task_report_c (gvm_connection_t *connection, const char *task_id,
                         char **report_id)
{
  entity_t entity;
  const char *status;
 ...
 */
int
omp_stop_task_c (gvm_connection_t *connection, const char* id)
{
  if (gvm_connection_sendf (connection,
                            "<stop_task task_id=\"%s\"/>",
                            id)
 ...
 */
int
omp_resume_task_report_c (gvm_connection_t *connection, const char* task_id,
                          char** report_id)
{
  if (gvm_connection_sendf (connection,
                            "<resume_task task_id=\"%s\"/>",
